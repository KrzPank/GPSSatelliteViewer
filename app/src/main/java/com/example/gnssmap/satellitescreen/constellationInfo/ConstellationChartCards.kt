...
import com.example.gnssmap.utils.GroupedChart
import com.example.gnssmap.utils.IndividualChart
import com.example.gnssmap.utils.getConstellationColor
import kotlin.collections.plus

@Composable
fun GroupedConstellationChartCard(
    dataHistory: Map<String, List<TimestampedData>>,
    label: String,
    modifier: Modifier = Modifier
) {
    val meaningfulSnrHistory = dataHistory.filterValues { list ->
        list.any { it.data != 0f }
    }
    ...
    Card(
        ...
        Column(
            ...
            GroupedChart(
                dataHistory = meaningfulSnrHistory,
...
@Composable
fun IndividualConstellationChartCard(
    constellationSNRHistory: List<TimestampedData>,
    ...
    Card(
        ...
        Column(
            ...
            IndividualChart(
                dataHistory = constellationSNRHistory,
